...
- You installed a bad theme. You can remove it by going into the `/atmosphere/contents/0100000000001000/romfs/lyt` or `/atmosphere/titles/0100000000001000/romfs/lyt` and deleting every file in that folder.
